...
function User(username, logInCount, signedIn) {
    ...
    // return naa bhu karei, to bhi chalega constructor function mei kyuki values initialize ho rahi bss
    // return this;
}

// Significance 'new' keyword (explore yourself more)
// is syntax se previous values override ho sakti hai, isiliye try to user 'new' keyword each time you call the constructor taaki har baar ek naya instance (copy) create ho har object ke liye
