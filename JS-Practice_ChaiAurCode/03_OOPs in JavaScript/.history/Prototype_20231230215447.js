...
// define a function 'trueLength' jo har string ke liye kaam karei, jismei actual length aaye, agar space ho to trim karke humei actual length de, ab baar baar trim() nhi karna chahte 
let userName = "ChaiAurCode    ";
