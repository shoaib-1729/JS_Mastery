...
// Garbage Collection (the garbage coolector finds the objects which are of no use or unwanted, then de-allocate the memory space they are occupying automatically)